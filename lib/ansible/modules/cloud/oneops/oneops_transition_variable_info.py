...
DOCUMENTATION = '''
---
module: oneops_transition_variable_info

short_description: A module for fetching details for a OneOps variable inside of a transition
...
def run_module():
    ...
    variable, _, _ = oneops_api.OneOpsTransitionVariable.get(module)
