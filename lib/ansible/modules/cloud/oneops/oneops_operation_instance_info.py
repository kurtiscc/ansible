...
DOCUMENTATION = '''
---
module: oneops_operation_instance_info
...
def get_oneops_component_info_module():
    return AnsibleModule(
        argument_spec=module_argument_spec.get_oneops_operation_instance_info_module_argument_spec(),
...
def run_module():
    ...
    module = get_oneops_component_info_module()

    instance, _, _ = oneops_api.OneOpsOperationInstance.get(module)
