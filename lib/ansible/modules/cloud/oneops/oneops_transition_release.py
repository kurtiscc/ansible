...
DOCUMENTATION = '''
---
module: oneops_transition_release
...
def get_oneops_transition_release_module():
    return AnsibleModule(
        argument_spec=module_argument_spec.get_oneops_transition_release_module_argument_spec(),
...
def run_module():
    ...
    # supports check mode
    module = get_oneops_transition_release_module()

    if module.params['release']['state'] == 'closed':
        return close_transition_release(module, state)

    if module.params['release']['state'] == 'discarded':
        return discard_transition_release(module, state)
